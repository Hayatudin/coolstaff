            ...
            <table className={`w-full border-collapse border-[1.5px] ${borderTeal} text-[11px] leading-tight text-black`}>
              <tbody>
                ...
                <tr>
                  ...
                  <td colSpan={2} className="border-b border-r border-[#0a5c4e] px-2 py-1 text-center font-extrabold text-[#d32f2f] uppercase font-roboto text-[15px]" style={{ fontFamily: "'Roboto', sans-serif", fontWeight: 'bold', fontSize: '15px' }}>{candidate.passportData?.passportNumber}</td>
