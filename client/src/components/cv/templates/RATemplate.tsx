              ...
              <table className="w-full border-collapse mt-[-2px]">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-black px-2 py-1 font-bold uppercase w-[50%] font-roboto text-[15px]" style={{ fontFamily: "'Roboto', sans-serif", fontWeight: 'bold', fontSize: '15px' }}>{candidate.passportData?.passportNumber}</td>
