          ...
          <div className="flex-1 flex flex-col gap-0">
            <table className="w-full border-collapse border-[1.5px] border-black text-[13px] leading-tight mb-[-1.5px]">
              ...
              <tbody>
                ...
                <tr><td className="border-[1.5px] border-black px-2 py-1 text-[#0066cc] font-bold">Passport No.</td><td className="border-[1.5px] border-black px-2 py-1 text-center font-black font-roboto text-[18px] tracking-wider" style={{ fontFamily: "'Roboto', sans-serif", fontWeight: '900', fontSize: '18px' }}>{candidate.passportData?.passportNumber}</td><td className="border-[1.5px] border-black px-2 py-1 text-right font-bold" dir="rtl">رقم جواز السفر</td></tr>
            ...
            <table className="w-full border-collapse border-[1.5px] border-black text-[13px] leading-tight">
              ...
              <tbody>
                ...
                <tr><td className="border-[1.5px] border-black px-2 py-1.5 text-[#0066cc] font-bold">Position</td><td className="border-[1.5px] border-black px-2 py-1.5 text-center uppercase">{expPosition}</td><td className="border-[1.5px] border-black px-2 py-1.5 text-right font-bold" dir="rtl">المهنة</td></tr>
              </tbody>
            </table>
          </div>
        </div>
