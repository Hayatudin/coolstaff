        ...
        <div className="flex gap-2 mb-2">
          ...
          <div className="flex-1">
            <table className="w-full border-collapse border-[1.5px] border-black text-[13.5px] leading-tight">
              ...
              <tbody>
                <tr><td className="border-[1.5px] border-black px-2 py-1.5 text-[#0066cc] font-extrabold w-[25%]">Full Name</td><td className="border-[1.5px] border-black px-2 py-1.5 font-black text-center w-[50%] uppercase text-[15px]">{fullName}</td><td className="border-[1.5px] border-black px-2 py-1.5 text-right font-extrabold w-[25%]" dir="rtl">الاسم الكامل</td></tr>
                <tr><td className="border-[1.5px] border-black px-2 py-1.5 text-[#0066cc] font-extrabold">Telephone</td><td className="border-[1.5px] border-black px-2 py-1.5 text-center font-bold">{candidate.personalInfo?.phone}</td><td className="border-[1.5px] border-black px-2 py-1.5 text-right font-extrabold" dir="rtl">رقم هاتف</td></tr>
                <tr><td className="border-[1.5px] border-black px-2 py-1.5 text-[#0066cc] font-extrabold">Position</td><td className="border-[1.5px] border-black px-2 py-1.5 text-center uppercase font-black text-[14px]">{candidate.personalInfo?.job || 'HOUSE MAID'}</td><td className="border-[1.5px] border-black px-2 py-1.5 text-right font-extrabold" dir="rtl">موضع</td></tr>
                <tr><td className="border-[1.5px] border-black px-2 py-1.5 text-[#0066cc] font-extrabold">Age</td><td className="border-[1.5px] border-black px-2 py-1.5 text-center font-bold">{age}</td><td className="border-[1.5px] border-black px-2 py-1.5 text-right font-extrabold" dir="rtl">عمر</td></tr>
                <tr><td className="border-[1.5px] border-black px-2 py-1.5 text-[#0066cc] font-extrabold">Date of Expiry</td><td className="border-[1.5px] border-black px-2 py-1.5 text-center font-bold">{formatDate(candidate.passportData?.dateOfExpiry)}</td><td className="border-[1.5px] border-black px-2 py-1.5 text-right font-extrabold" dir="rtl">تاريخ الانتهاء</td></tr>
              </tbody>
            </table>
          </div>
        </div>
