  ...
  sections: [
    {
      ...
      children: [
        ...
        new Table({
          ...
          rows: [
            // Face photo column is now narrower (5 columns instead of 8)
...
Packer.toBuffer(doc).then((buffer) => {
  fs.writeFileSync("templates/CV KA-7.docx", buffer);
  console.log("Document CV KA-7.docx updated successfully in templates/");
